...
Contact information that you provide will be displayed on the site in the hCard microformat (http://microformats.org/wiki/hcard). An hCard is a small bundle of code that you want to put on your web site so that Google Maps (and other mapping services) can more easily index the site's location information.
...
THANKS
======
Thanks to Shawn DeArmond, author of the hCard module on drupal.org which inspired this module.
